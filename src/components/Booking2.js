...
const Booking2 = () => {
    ...
    return(
                ...
                <div style={{display:"flex",justifyContent:'center', alignItems:'center',fontFamily:"Roboto",fontSize:"20px",background:"linear-gradient(90deg,  #000000 0%, #417dff 100%)",height:"100vh"}}>
